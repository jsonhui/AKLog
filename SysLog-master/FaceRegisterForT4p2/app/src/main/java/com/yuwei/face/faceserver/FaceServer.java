...
public class FaceServer {
    ...
    public static String ROOT_PATH ="/mnt/sdcard";
    ...
    private void initFaceList(Context context) {
        synchronized (this) {
            ...
            Log.i(TAG,"path==>"+featureDir.getAbsolutePath());
...
//                featureDir.mkdirs();
    ...
    public boolean register(Context context, byte[] nv21, int width, int height, String name) {
        synchronized (this) {
            ...
            Log.i(TAG,"111--code:"+code+"--faceInfoList.size():"+faceInfoList.size());
            if (code == ErrorInfo.MOK && faceInfoList.size() > 0) {
                ...
                try {
                    ...
                    if (code == ErrorInfo.MOK) {
                        ...
                        Log.i(TAG,"333--needAdjust:"+needAdjust);
                        if (needAdjust) {
