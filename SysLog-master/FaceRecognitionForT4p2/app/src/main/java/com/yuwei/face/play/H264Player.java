...
public class H264Player{
	...
	public final static int VIDEO_WIDTH = 800;
	...
	public ReceiveYuvFrameCallBack getmReceiveYuvFrameCallBack() {
		return mReceiveYuvFrameCallBack;
	}

	public void setmReceiveYuvFrameCallBack(ReceiveYuvFrameCallBack mReceiveYuvFrameCallBack) {
		this.mReceiveYuvFrameCallBack = mReceiveYuvFrameCallBack;
	}

	private ReceiveYuvFrameCallBack mReceiveYuvFrameCallBack;
